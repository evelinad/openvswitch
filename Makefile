...
#am__append_35 = ovsdb/ovsdbmonitor/ovsdbmonitor
#am__append_36 = \
#	ovsdb/ovsdbmonitor/ovsdbmonitor \
#	ovsdb/ovsdbmonitor/ovsdbmonitor.tmp

#am__append_37 = ovsdb/ovsdbmonitor/ovsdbmonitor.1
am__append_38 = vtep/vtep.gv vtep/vtep.pic
subdir = .
...
DATA = $(desktop_DATA) $(dist_pkgdata_DATA) $(dist_scripts_DATA) \
...
am__noinst_HEADERS_DIST = BUILD.Windows CodingStyle DESIGN FAQ INSTALL \
	...
	vtep/vtep-ctl.8.in build-aux/thread-safety-blacklist \
	m4/absolute-header.m4 m4/include_next.m4 lib/string.h.in \
	...
	debian/openvswitch-vtep.manpages debian/ovsdbmonitor.install \
	...
	ovsdb/ovsdbmonitor/ovsdbmonitor.desktop rhel/README.RHEL \
...
ACLOCAL = ${SHELL} /home/evelina/Downloads/openvswitch-2.1.0/build-aux/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /home/evelina/Downloads/openvswitch-2.1.0/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /home/evelina/Downloads/openvswitch-2.1.0/build-aux/missing --run autoheader
AUTOM4TE = ${SHELL} /home/evelina/Downloads/openvswitch-2.1.0/build-aux/missing --run autom4te
AUTOMAKE = ${SHELL} /home/evelina/Downloads/openvswitch-2.1.0/build-aux/missing --run automake-1.11
AWK = mawk
...
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/evelina/Downloads/openvswitch-2.1.0/build-aux/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
...
PACKAGE_STRING = openvswitch 2.1.0
...
PYUIC4 = ${SHELL} /home/evelina/Downloads/openvswitch-2.1.0/build-aux/missing --run pyuic4
RANLIB = ranlib
...
abs_builddir = /home/evelina/Downloads/openvswitch-2.1.0
abs_srcdir = /home/evelina/Downloads/openvswitch-2.1.0
abs_top_builddir = /home/evelina/Downloads/openvswitch-2.1.0
abs_top_srcdir = /home/evelina/Downloads/openvswitch-2.1.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/evelina/Downloads/openvswitch-2.1.0/build-aux/install-sh
...
DISTCLEANFILES = utilities/ovs-appctl.8 utilities/ovs-ctl \
	...
	ovsdb/ovsdb-dot $(am__append_36) vtep/vtep-ctl.8 \
	$(am__append_38) vtep/vtep.5
...
UNINSTALL_LOCAL = $(am__append_27) ovsdbmonitor-uninstall-local \
	ovs-uninstall-local
# ovsdb-tool.1
# ovsdb-client.1
# ovsdb-server.1
man_MANS = utilities/ovs-appctl.8 utilities/ovs-benchmark.1 \
	...
	vswitchd/ovs-vswitchd.conf.db.5 ovsdb/ovsdb-tool.1 \
	ovsdb/ovsdb-client.1 ovsdb/ovsdb-server.1 $(am__append_37) \
	vtep/vtep-ctl.8
...
noinst_SCRIPTS = ovsdb/ovsdb-idlc ovsdb/ovsdb-dot $(am__append_35)
...
SUFFIXES = .in $(am__append_31) .ovsidl .ovsschema .ui .py
...
$(srcdir)/manpages.mk $(srcdir)/m4/automake.mk $(srcdir)/lib/automake.mk $(srcdir)/ofproto/automake.mk $(srcdir)/utilities/automake.mk $(srcdir)/utilities/bugtool/automake.mk $(srcdir)/tests/automake.mk $(srcdir)/include/automake.mk $(srcdir)/include/linux/automake.mk $(srcdir)/include/openflow/automake.mk $(srcdir)/include/openvswitch/automake.mk $(srcdir)/include/sparse/automake.mk $(srcdir)/third-party/automake.mk $(srcdir)/debian/automake.mk $(srcdir)/vswitchd/automake.mk $(srcdir)/ovsdb/automake.mk $(srcdir)/ovsdb/ovsdbmonitor/automake.mk $(srcdir)/rhel/automake.mk $(srcdir)/xenserver/automake.mk $(srcdir)/python/automake.mk $(srcdir)/python/compat/automake.mk $(srcdir)/tutorial/automake.mk $(srcdir)/vtep/automake.mk:
...
mostlyclean-compile:
	...
	-rm -f ovsdb/ovsdb_libovsdb_la-ovsdb-server.$(OBJEXT)
	-rm -f ovsdb/ovsdb_libovsdb_la-ovsdb-server.lo
...
ovsdb/ovsdb_libovsdb_la-ovsdb-server.lo: ovsdb/ovsdb-server.c
	...
	$(am__mv) ovsdb/$(DEPDIR)/ovsdb_libovsdb_la-ovsdb-server.Tpo ovsdb/$(DEPDIR)/ovsdb_libovsdb_la-ovsdb-server.Plo
#	source='ovsdb/ovsdb-server.c' object='ovsdb/ovsdb_libovsdb_la-ovsdb-server.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(LIBTOOL)  --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(ovsdb_libovsdb_la_CPPFLAGS) $(CPPFLAGS) $(ovsdb_libovsdb_la_CFLAGS) $(CFLAGS) -c -o ovsdb/ovsdb_libovsdb_la-ovsdb-server.lo `test -f 'ovsdb/ovsdb-server.c' || echo '$(srcdir)/'`ovsdb/ovsdb-server.c
...
uninstall-ovsdbmonitorDATA:
	...
	@list='$(ovsdbmonitor_DATA)'; test -n "$(ovsdbmonitordir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(ovsdbmonitordir)'; $(am__uninstall_files_from_dir)
...
installdirs-am:
	for dir in "$(DESTDIR)$(libdir)" "$(DESTDIR)$(bindir)" "$(DESTDIR)$(sbindir)" "$(DESTDIR)$(bindir)" "$(DESTDIR)$(pkgdatadir)" "$(DESTDIR)$(sbindir)" "$(DESTDIR)$(scriptsdir)" "$(DESTDIR)$(sbindir)" "$(DESTDIR)$(scriptsdir)" "$(DESTDIR)$(man1dir)" "$(DESTDIR)$(man5dir)" "$(DESTDIR)$(man8dir)" "$(DESTDIR)$(desktopdir)" "$(DESTDIR)$(pkgdatadir)" "$(DESTDIR)$(scriptsdir)" "$(DESTDIR)$(pkgdatadir)" "$(DESTDIR)$(ovsdbmonitordir)" "$(DESTDIR)$(pkgdatadir)" "$(DESTDIR)$(scriptsdir)"; do \
...
install-data-am: install-data-local install-desktopDATA \
	...
	install-ovsdbmonitorDATA install-pkgdataDATA \
...
.PHONY: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) CTAGS GTAGS \
	...
	install-desktopDATA install-dist_pkgdataDATA \
